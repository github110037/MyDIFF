...
class Pmem : public PaddrInterface  {/*{{{*/
    ...
    public:
        ...
        Pmem(size_t size_bytes, const unsigned char *init_binary, size_t init_binary_len): Pmem(size_bytes) {
            // Initalize memory 
            assert(init_binary_len <= size_bytes);
            memcpy(mem,init_binary,init_binary_len);
        }
        Pmem(size_t size_bytes, const char *init_file): Pmem(size_bytes) {
